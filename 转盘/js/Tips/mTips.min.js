...
! function() {
	window.Tips = {
		_create: function() {
			if(!this.BG) {
				var a = document.getElementsByTagName("body")[0],
					b = '<div id="aTips_box"><div id="aTips_content"></div><div id="aTips_foot"><a href="javascript:;" id="aTips_cancel">取消</a><a href="javascript:;" id="aTips_define">确定</a></div></div>';
		...
		_setBtn: function(a, b) {
			switch(this.foot.style.display = "block", this.define.style.display = "", this.cancel.style.display = "", parseInt(a)) {
				case 1:
					...
					break;
				case 2:
					this.define.className = "", "function" == typeof b ? (this.define.innerText = "确定", this.cancel.innerText = "取消", this._define(function(a) {
						b && b(a)
					}), this._cancel(function(a) {
						b && b(a)
					})) : (this.define.innerText = b.define || "确定", this.cancel.innerText = b.cancel || "取消", this._define(b), this._cancel(b));
					break;
				case 0:
		...
		_set2: function(a) {
			a = a || "加载中", this._create2(), this.loadBox.innerText = a
		},
		loadShow: function(a) {
